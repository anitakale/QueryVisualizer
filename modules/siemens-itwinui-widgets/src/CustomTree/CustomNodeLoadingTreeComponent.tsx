...
import { AbstractWidgetProps, PropertyRecord, StagePanelLocation, StagePanelSection, UiItemsProvider, WidgetState } from "@itwin/appui-abstract";
import {
 ...
 *     - Child node 1   [from inMemoryDataProvider]
 */
export const CustomNodeLoadingTree: FunctionComponent<CustomNodeLoadingTreeProps> = (_props) => {
  ...
  const presentationDataProvider = React.useMemo(() => new PresentationProvider(iModelConnection!), [iModelConnection]);
...
class CustomNodeLoader extends PagedTreeNodeLoader<TreeDataProvider> {
  ...
  public override loadNode(parent: TreeModelNode | TreeModelRootNode, childIndex: number) {
...
class InnerNodeLoader extends PagedTreeNodeLoader<TreeDataProvider> {
  ...
  public override updateModel(loadedHierarchy: LoadedNodeHierarchy) {
  ...
  public override loadNode(parentNode: TreeModelNode | TreeModelRootNode, childIndex: number) {
...
class PresentationProvider extends PresentationTreeDataProvider {
  ...
  public override async getNodes(parentNode?: TreeNodeItem, pageOptions?: PageOptions): Promise<DelayLoadedTreeNodeItem[]> {
...
class InMemoryDataProvider extends SampleDataProvider {
  public override async getNodes(parentNode?: TreeNodeItem) {
...
export class CustomNodeLoadingTreeWidgetProvider implements UiItemsProvider {
  public readonly id: string = "CustomNodeLoadingTreeWidgetProvider";
  ...
  public provideWidgets(_stageId: string, _stageUsage: string, location: StagePanelLocation, _section?: StagePanelSection): ReadonlyArray<AbstractWidgetProps> {
    ...
    if (location === StagePanelLocation.Left) {
      widgets.push(
        {
          id: "CustomNodeLoadingTreeWidget",
          label: "Hierarchy View",
          defaultState: WidgetState.Floating,
          // eslint-disable-next-line react/display-name
          getWidgetContent: () => <CustomNodeLoadingTree />,
        },
      );
    }
    return widgets;

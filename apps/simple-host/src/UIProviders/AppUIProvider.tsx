  ...
  public provideToolbarButtonItems(
    ...
    if (
      ...
      const xhqViewPortButton = ToolbarItemUtilities.createActionButton(
        ...
        (): void => {
          if (
            StateManager.store.getState().SiemensSampleApp.isXhqViewsDialogOpen
          ) {
            ...
            StateManager.store.dispatch(
              SiemensSampleAppActions.setIsXhqViewsDialogOpen(false)
            );
          } else {
            ...
            StateManager.store.dispatch(
              SiemensSampleAppActions.setIsXhqViewsDialogOpen(true)
            );
          }
        },
        {
